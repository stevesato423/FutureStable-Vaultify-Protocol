...
contract PriceCalculator is IPriceCalculator {
    ...
    function avgPrice(
        uint8 _hours,
        AggregatorV3InterfaceForTest _priceFeed
    ...
    function getTokenScaleDiff(
        ...
        return
            _symbol == NATIVE ? 0 : 18 - IERC20Mock(_tokenAddress).decimals();
    }
    ...
    function tokenToEurAvg(
        ...
        AggregatorV3InterfaceForTest tokenUsdClFeed = AggregatorV3InterfaceForTest(
                _token.clAddr
            );
