...
//     constructor(
//         address _liquidationPoolManager,
...
//     {
//         uint256 _id = (block.number %
//             ISmartVaultManager(smartVaultManager).totalSupply()) + 1;
//         try
//             ISmartVault(ISmartVaultIndex(vaultIndex).getVaultAddress(_id))
//                 .undercollateralised()
//         returns (bool _undercollateralised) {
